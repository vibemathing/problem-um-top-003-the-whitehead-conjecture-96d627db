...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-top-003-the-whitehead-conjecture-96d627db-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/TOP-003"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-top-003-the-whitehead-conjecture-96d627db-v1",
      "problem_contract_sha256": "50c138c75673692af39318772e8519ff3b20902f649b3cc93935a7001739fc50",
      "problem_id": "problem:um-top-003-the-whitehead-conjecture-96d627db",
      "route_id": "route:um-top-003-the-whitehead-conjecture-96d627db-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-top-003-the-whitehead-conjecture-96d627db-source-fidelity-01",
      "graph_id": "graph:um-top-003-the-whitehead-conjecture-96d627db-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-top-003-the-whitehead-conjecture-96d627db-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-top-003-the-whitehead-conjecture-96d627db-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is every aspherical closed manifold whose fundamental group has no non-trivial perfect normal subgroups a $K(\\pi, 1)$ space?"
          },
          "statement_sha256": "0f707db47a6b296ed3a15cacd5e9c01d2ab3bd3e49bb156341d192020cb4a2c9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-top-003-the-whitehead-conjecture-96d627db-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-top-003-the-whitehead-conjecture-96d627db-root",
      "route_id": "route:um-top-003-the-whitehead-conjecture-96d627db-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-top-003-e906ccb0168a",
        "url": "https://www.unsolvedmath.com/problems/TOP-003"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
